from memberships.models import FeaturedMembership, FeaturedMembershipFeature
...
def update_membership(request, membership_id):
    ...
    try:
        membership = FeaturedMembership.objects.get(pk=membership_id)
    ...
    try:
        ...
        if features:
            ...
            for feature in features:
                feature_model, created = FeaturedMembership.objects.get_or_create(
                    feature=feature,
