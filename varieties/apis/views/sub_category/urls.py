...
urlpatterns = [
    ...
    path('subcategories/<str:category_name>/',
         get_category_subcategories, name='get_category_subcategories'),
    path('subcategories/create/', create_subcategory, name='create_subcategory'),
    path('subcategories/<int:pk>/update/',
         update_subcategory, name='update_subcategory'),
    path('subcategories/<int:pk>/delete/',
